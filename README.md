...
| **Size** | ~450MB | ~2.2GB (includes tooling) |
...
|-----|-------------|------|
| `latest` | Stable with Python 3.12 + 3.14 | ~2.2GB |
| `v2` | Versioned release | ~2.2GB |
...
| `ghcr.io/drmicalet/arch-base-privileged` | ✅ | ✅ | ✅ (default) | ✅ | ✅ | ~2.2GB |
